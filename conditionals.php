...
$message = ($redLight = true) ? "Stop the car!" : "You can go";
echo "<p>$message</p>";
...
if($greenLight == false && $yellowLight || $redLight){
  echo "Stop the car!";
...
switch(true) {
case $greenLight && $yellowLight == false && $redLight == false:
  echo "Keep moving";
  break;
case $greenLight == false && $yellowLight || $redLight:
  echo "Stop the car";
  break;
